...
# 	
# 	
# ## Different example: SuperIQ drug test	
# 	
...
# 	
# 	
# ## Different example: SuperIQ drug test, within-subjects variant	
# 	
...
IQ_pre_placebo_group = mvrnorm(n = total_N/2,	
                      mu = c(0, 0),	
                      Sigma = matrix(c(1, r,	
                                       r, 1), nrow = 2))	
	
IQ_pre_treatment_group = mvrnorm(n = total_N/2,	
                      mu = c(0, 0),	
                      Sigma = matrix(c(1, r,	
                                       r, 1), nrow = 2))	
...
time_labels = rep(rep(c("baseline", "posttest"), each = total_N/4), 2)	
	
  simulated_data = data.frame(IQ = IQ_all, group = groups_labels, time = time_labels)	
