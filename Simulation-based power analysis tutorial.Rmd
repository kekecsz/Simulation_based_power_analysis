---
title: "Simulation-based sample size estimation - Tutorial"
...
```{r data integrated simulation and analysis function}
...
```{r minimum detectable effect size}
...
```{r integrated simulation and analysis function _group_means}
...
```{r save all decisions _group_means}
...
```{r calculate power _group_means}
...
```{r optimize sample size _group_means}
...
```{r integrated simulation and analysis function _within_means}
...
```{r save all decisions _within_means}
...
```{r calculate power _within_means}
...
```{r optimal sample size _within_means}
...
```{r example regression-based-simulation}
...
```{r example regression-based-simulation analysis} 
...
```{r example regression-based-simulation simulation plus analysis} 
...
```{r example regression-based-simulation iterate} 
...
```{r example regression-based-simulation calculate}
...
```{r example regression-based-simulation optimize}
